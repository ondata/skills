...
description: >
  ...
  on public data, captchas blocking automated access, a PA site unreachable from abroad /
  geo-blocking (IP-geolocation access restrictions), unanswered data reuse requests (D.Lgs.
